// BeatConnect - Supabase Configuration (Versão Simplificada)
...
/**
 * Autentica um administrador (versão simplificada)
...
async function authenticateAdmin(username, password) {
    try {
        // Autenticação hardcoded para resolver o problema
...
// - submitBeat(beatData)
// - authenticateAdmin(username, password) - VERSÃO SIMPLIFICADA
// - getAllBeats()
